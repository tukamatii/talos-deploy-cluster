## Talos Kubernetes Cluster Deployment Role

- [Talos Kubernetes Cluster Deployment Role](#talos-kubernetes-cluster-deployment-role)
  - [1. Введение](#1-введение)
  - [2. Требования](#2-требования)
    - [2.1. Предварительные условия](#21-предварительные-условия)
    - [2.2. Зависимости Ansible Collections](#22-зависимости-ansible-collections)
  - [3. Переменные](#3-переменные)
    - [3.1. Обязательные переменные](#31-обязательные-переменные)
    - [3.2. Критически важные опциональные переменные](#32-критически-важные-опциональные-переменные)
    - [3.3. Переменные vCenter (групповые)](#33-переменные-vcenter-групповые)
  - [4. Примеры использования](#4-примеры-использования)
    - [4.1. Инвентарь (группа `talos-cluster-test`)](#41-инвентарь-группа-talos-cluster-test)
    - [4.2. Групповые переменные](#42-групповые-переменные)
    - [4.3. Плейбук](#43-плейбук)
  - [5. Логика работы с аддонами](#5-логика-работы-с-аддонами)
    - [5.1. Структура репозитория аддона](#51-структура-репозитория-аддона)
    - [5.2. Алгоритм применения аддонов](#52-алгоритм-применения-аддонов)
    - [5.3. Особенности](#53-особенности)
